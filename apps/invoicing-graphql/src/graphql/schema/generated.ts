...
> = {
  ...
  setTransactionToActive?: Resolver<
    ...
    ParentType,
    ContextType,
    MutationSetTransactionToActiveArgs
  >;
  ...
  recordPayPalPayment?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationRecordPayPalPaymentArgs,
      'paymentMethodId' | 'invoiceId' | 'payerId' | 'orderId'
    >
  >;
  ...
  migrateEntireInvoice?: Resolver<
    ...
    RequireFields<
      ...
      'invoiceId' | 'apc' | 'submissionDate' | 'token'
    >
  >;
};
...
> = {
  ...
  invoiceIdByManuscriptCustomId?: Resolver<
    ...
    ParentType,
    ContextType,
    QueryInvoiceIdByManuscriptCustomIdArgs
  >;
  journals?: Resolver<
