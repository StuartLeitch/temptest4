...
const sp_refresh_manuscripts_as_table_migration = `
...
const sp_refresh_manuscripts_as_table_migration_rollback = `
CREATE OR REPLACE PROCEDURE public.sp_refresh_manuscripts_as_table()
 LANGUAGE 'plpgsql'
AS $procedure$
begin
...
export async function up(knex: Knex): Promise<any> {
	return Promise.all([
	  knex.raw(sp_refresh_manuscripts_as_table_migration),
	]);
  }
  ...
  export const name = '20220503115016_fix_manuscripts_editorial_assistant_data_order_issue';
