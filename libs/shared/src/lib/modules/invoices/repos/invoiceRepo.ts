...
export interface InvoiceRepoContract extends Repo<Invoice> {
  ...
  getFailedSageErpInvoices(): Promise<
    Either<GuardFailure | RepoError, InvoiceId[]>
  >;
  getFailedNetsuiteErpInvoices(): Promise<
    Either<GuardFailure | RepoError, InvoiceId[]>
  >;
  getUnrecognizedSageErpInvoices(): Promise<
    Either<GuardFailure | RepoError, InvoiceId[]>
  >;
  getUnrecognizedNetsuiteErpInvoices(): Promise<
    Either<GuardFailure | RepoError, InvoiceId[]>
  >;
  ...
  getUnrecognizedReversalsNetsuiteErp(): Promise<
