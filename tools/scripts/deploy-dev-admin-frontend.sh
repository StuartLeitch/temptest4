...
aws --profile=production elasticbeanstalk update-environment --environment-name $AWS_ENVIRONMENT-invoicing-admin-frontend --version-label $AWS_ENVIRONMENT-invoicing-admin-frontend
